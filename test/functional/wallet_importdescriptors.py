...
class ImportDescriptorsTest(BitcoinPurpleTestFramework):
    ...
    def run_test(self):
        ...
        addresses = [
            'rbtcp1qtmp74ayg7p24uslctssvjm06q5phz4yrwxzxsu', # m/0'/0'/0
            'rbtcp1q8vprchan07gzagd5e6v9wd7azyucksq2wzy54h', # m/0'/0'/1
            'rbtcp1qtuqdtha7zmqgcrr26n2rqxztv5y8rafjfl9juv', # m/0'/0'/2
            'rbtcp1qau64272ymawq26t90md6an0ps99qkrseuap5kl', # m/0'/0'/3
            'rbtcp1qsg97266hrh6cpmutqen8s4s962aryy776m48tl', # m/0'/0'/4
        ]
        ...
        assert_equal(address, "PgZrMiknsdxvzpZaUwAGBanuBrux3sbvdD")
        ...
        assert_equal(addr, 'rbtcp1qdt0qy5p7dzhxzmegnn4ulzhard33s2809arjqgjndx87rv5vd0fqfx2cya') # Derived at m/84'/0'/0'/0
        change_addr = wmulti_priv.getrawchangeaddress('bech32') # uses change 0
        assert_equal(change_addr, 'rbtcp1qt9uhe3a9hnq7vajl7a094z4s3crm9ttf8zw3f5v9gr2nyd7e3lns8tau8r') # Derived at m/84'/1'/0'/0
        ...
        assert_equal(addr, 'rbtcp1qp8s25ckjl7gr6x2q3dx3tn2pytwp05upkjztk6ey857tt50r5aeqsynrrl') # Derived at m/84'/0'/0'/1
        change_addr = wmulti_pub.getrawchangeaddress('bech32') # uses change 2
        assert_equal(change_addr, 'rbtcp1qp6j3jw8yetefte7kw6v5pc89rkgakzy98p6gf7ayslaveaxqyjusssug0z') # Derived at m/84'/1'/0'/2
