...
class WalletSignerTest(BitcoinPurpleTestFramework):
    ...
    def test_valid_signer(self):
        ...
        assert_equal(address1, "rbtcp1qm90ugl4d48jv8n6e5t9ln6t9zlpm5th60u08yc")
        ...
        assert_equal(address2, "PJ2MVghrXcn9329nrQzdo55h4A4XHEmReK")
        ...
        assert_equal(address3, "Psk9VkmjaScWhBb5qTUwLRtfuKjRtvF1QQ")
        ...
        assert_equal(address4, "rbtcp1phw4cgpt6cd30kz9k4wkpwm872cdvhss29jga2xpmftelhqll62msk8dlqg")
