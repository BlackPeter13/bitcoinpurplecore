...
class ScantxoutsetTest(BitcoinPurpleTestFramework):
    ...
    def run_test(self):
        ...
        self.sendtodestination("PchJrDhTHnA9pdmgDURbH9H1U9d56KvRYc", 0.008)  # (m/0'/0'/0')
        self.sendtodestination("PbEJHTNT7oY8stnAXK6N7VAiAjdu443B4d", 0.016)  # (m/0'/0'/1')
        self.sendtodestination("PuXT1JFFJuX6HWV7iWnKaLGbbXfEAxNwme", 0.032)  # (m/0'/0'/1500')
        self.sendtodestination("PhqyGrHHjSqz27aUcoMifJpifShvGxSRV9", 0.064)  # (m/0'/0'/0)
        self.sendtodestination("PesVvi6fo8NQiSuZPEbaZLGLVMPxAN4b5z", 0.128)  # (m/0'/0'/1)
        self.sendtodestination("Pd4i3ehL6YfHfoLwroWHYQKufvkq4KdXuV", 0.256)  # (m/0'/0'/1500)
        self.sendtodestination("PbYp72Tk8h9PXh9ArKhGif6a741cx7h2Sj", 0.512)  # (m/1/1/0')
        self.sendtodestination("PYC9fM1PcyJXbxZFNTapgkR8rJDbhxMCYy", 1.024)  # (m/1/1/1')
        self.sendtodestination("PgJvTCcuXTXbPTgFXneyReTgAstzeTmWF1", 2.048)  # (m/1/1/1500')
        self.sendtodestination("Pm5JeWC76Qai1gVfUrhGnNzFN4dojNXXAp", 4.096)  # (m/1/1/0)
        self.sendtodestination("PqDwn9LHP5ge7VTgYMhsAbxdGK7PupBKgm", 8.192)  # (m/1/1/1)
        self.sendtodestination("PgoxhqMKetXGC3de51vZngWW7RLs7Gw7QV", 16.384)  # (m/1/1/1500)
