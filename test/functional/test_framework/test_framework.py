...
from .address import create_deterministic_address_rbtcp1_p2tr_op_true
...
class BitcoinPurpleTestFramework(metaclass=BitcoinPurpleTestMetaClass):
    ...
    def _initialize_chain(self):
        ...
        if not os.path.isdir(cache_node_dir):
            ...
            gen_addresses = [k.address for k in TestNode.PRIV_KEYS][:3] + [create_deterministic_address_rbtcp1_p2tr_op_true()[0]]
