...
ADDRESS_BCRT1_UNSPENDABLE = 'rbtcp1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqjc5kyg'
ADDRESS_BCRT1_UNSPENDABLE_DESCRIPTOR = 'addr(rbtcp1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqjc5kyg)#emlvygy7'
# Coins sent to this address can be spent with a witness stack of just OP_TRUE
ADDRESS_BCRT1_P2WSH_OP_TRUE = 'rbtcp1qft5p2uhsdcdc3l2ua4ap5qqfg4pjaqlp250x7us7a8qqhrxrxfsqn84h8w'
...
def create_deterministic_address_rbtcp1_p2tr_op_true():
    """
    ...
    assert_equal(address, 'rbtcp1p9yfmy5h72durp7zrhlw9lf7jpwjgvwdg0jr0lqmmjtgg83266lqs6g40k8')
...
def program_to_witness(version, program, main=False):
    ...
    return encode_segwit_address("btcp" if main else "rbtcp", version, program)
...
def bech32_to_bytes(address):
    ...
    if hrp not in ['btcp', 'tbtcp', 'rbtcp']:
        return (None, None)
...
def address_to_scriptpubkey(address):
    ...
    if version == 56:  # Bitcoin Purple regtest pubkey hash
        return keyhash_to_p2pkh_script(payload)
    elif version == 55:  # Bitcoin Purple regtest script hash
