...
class SignMessagesWithPrivTest(BitcoinPurpleTestFramework):
    ...
    def run_test(self):
        ...
        priv_key = 'UCB1GauS4P9MD1PNBarxqUzPwBdxvFgx6zqGDkDRyNxiWCsGmC2T'
        expected_signature = 'H+POpJjw3ET9IJNAA5lUqhe8Ms42xSnB9+Z0gEX8Xx0wKcgK3WNhXYG1qH3CCKZ1rf4zvX1GE4wKcLfkm6S6afs='
        ...
        assert_equal(addresses[0], 'PgkEagvG6fd1DePj1EBhqGkok5nFPfuNVG')
        ...
        assert_raises_rpc_error(-3, "Malformed base64 encoding", self.nodes[0].verifymessage, 'PgkEagvG6fd1DePj1EBhqGkok5nFPfuNVG', "invalid_sig", message)
