...
class WalletDescriptorTest(BitcoinPurpleTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-4, "Only legacy wallets are supported by this command", recv_wrpc.rpc.importprivkey, "UDLw7yss5D4zZLzXuRbfxPoVqdfvLnVvPyaF2SxSQYuCvmTsgSKa")
