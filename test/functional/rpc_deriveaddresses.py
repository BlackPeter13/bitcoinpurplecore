...
class DeriveaddressesTest(BitcoinPurpleTestFramework):
    ...
    def run_test(self):
        ...
        address = "rbtcp1qjqmxmkpmxt80xz4y3746zgt0q3u3ferre08kwy"
        ...
        assert_equal(self.nodes[0].deriveaddresses(ranged_descriptor, [1, 2]), ["rbtcp1qhku5rq7jz8ulufe2y6fkcpnlvpsta7rqa00yw5", "rbtcp1qpgptk2gvshyl0s9lqshsmx932l9ccsv2jw3z7s"])
        assert_equal(self.nodes[0].deriveaddresses(ranged_descriptor, 2), [address, "rbtcp1qhku5rq7jz8ulufe2y6fkcpnlvpsta7rqa00yw5", "rbtcp1qpgptk2gvshyl0s9lqshsmx932l9ccsv2jw3z7s"])
        ...
        assert_equal(self.nodes[0].deriveaddresses(combo_descriptor), ["Pm5JeWC76Qai1gVfUrhGnNzFN4dojNXXAp", "Pm5JeWC76Qai1gVfUrhGnNzFN4dojNXXAp", address, "PVGC6xeC8PxyMrwnNARLsM9MJcco71y2Dk"])
        ...
        assert_equal(self.nodes[0].deriveaddresses(descsum_create("wpkh(tprv8ZgxMBicQKsPd7Uf69XL1XwhmjHopUGep8GuEiJDZmbQz6o58LninorQAfcKZWARbtRtfnLcJ5MQ2AtHcQJCCRUcMRvmDUjyEmNUWwx8UbK/1/1/*)"), [2147483647, 2147483647]), ["rbtcp1qtzs23vgzpreks5gtygwxf8tv5rldxvvsvnmr4c"])
